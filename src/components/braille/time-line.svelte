...
<section
    class="md:w-full md:h-full flex flex-col justify-center items-center p-3.5 gap-2 overflow-x-auto min-w-full"
>
    ...
    <article class="w-full flex justify-around items-center gap-5">
        ...
        {#if currentIndex === -1}
            <button
                class="brightness-90 bg-[#EDFEFE] text-[#1a5f70] h-full flex-1 rounded-md text-lg cursor-pointer transition-all ease-in-out duration-300 text-inter"
                disabled
